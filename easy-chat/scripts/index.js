...
EasyChat.prototype.new = function() {
    this.newButton = document.getElementById('create');
    this.newButton.addEventListener('click', newWindow);
}

function create() {
    let roomName = document.getElementById('text').value;
    let roomText = document.getElementById('textarea').value;
    window.location.href = 'index.html?roomName='+roomName+'&roomText='+roomText;
}

EasyChat.prototype.createButton = function() {
...
EasyChat,prototype.room = function() {
    this.room = document.getElementById('room');
    this.room.addEventListener('click',room);
}
